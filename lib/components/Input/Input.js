...
exports.TextInput = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: classnames_1.default(Input_module_scss_1.default.wrapper, Input_module_scss_1.default[variant], className, classNamePrefix + "--wrapper"), style: style },
        label ? (react_1.default.createElement("div", { className: classnames_1.default(Input_module_scss_1.default.label, Input_module_scss_1.default[variant], classNamePrefix + "--label") }, label)) : null,
