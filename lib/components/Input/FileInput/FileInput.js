...
exports.FileInput = exports.InputVariant = void 0;
...
exports.FileInput = function (_a) {
    var _b;
    var variant = _a.variant, name = _a.name, _c = _a.emptyMessage, emptyMessage = _c === void 0 ? "Select or drop a file" : _c, label = _a.label, _d = _a.isClearable, isClearable = _d === void 0 ? true : _d, _e = _a.accept, accept = _e === void 0 ? "image/*" : _e, onChange = _a.onChange, style = _a.style, className = _a.className, classNamePrefix = _a.classNamePrefix, dropAreaProps = _a.dropAreaProps, rest = __rest(_a, ["variant", "name", "emptyMessage", "label", "isClearable", "accept", "onChange", "style", "className", "classNamePrefix", "dropAreaProps"]);
    var initialValue = [];
    var _f = react_1.useState(initialValue), currentValue = _f[0], setCurrentValue = _f[1];
    ...
    return (react_1.default.createElement("div", { className: classnames_1.default(FileInput_module_scss_1.default.wrapper, FileInput_module_scss_1.default[variant], className, classNamePrefix + "--wrapper"), style: style },
        ...
        react_1.default.createElement(react_file_drop_1.FileDrop, __assign({}, dropAreaProps, { onDrop: function (files, e) {
            ...
            react_1.default.createElement("label", { htmlFor: "file-input", className: classnames_1.default(FileInput_module_scss_1.default.container, FileInput_module_scss_1.default[variant], classNamePrefix + "--container", (_b = {},
                ...
                currentValue.length > 0 ? (react_1.default.createElement("div", { className: FileInput_module_scss_1.default.value },
                    currentValue.map(function (file) { return (react_1.default.createElement("div", { key: file, className: classnames_1.default(FileInput_module_scss_1.default.files, FileInput_module_scss_1.default[variant], classNamePrefix + "--files") }, file)); }),
                    isClearable && (react_1.default.createElement(assets_1.Clear, __assign({ className: classnames_1.default(FileInput_module_scss_1.default.clear, classNamePrefix + "--clear"), viewBox: "0 0 24 24", onClick: clear }, clearOptions))))) : (react_1.default.createElement("div", { className: classnames_1.default(FileInput_module_scss_1.default.empty, classNamePrefix + "--empty") }, emptyMessage))))));
};
