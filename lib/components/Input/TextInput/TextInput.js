...
exports.TextInput = function (_a) {
    ...
    var _d = react_1.useState(false), invalid = _d[0], setInvalid = _d[1];
    var _e = react_1.useState(""), validationMessage = _e[0], setValidationMessage = _e[1];
    var _f = react_1.useState(initialValue ? initialValue : ""), currentValue = _f[0], setCurrentValue = _f[1];
    var clear = function () {
        setCurrentValue("");
    };
    var Icon = icon
    ...
    return (react_1.default.createElement("div", { className: classnames_1.default(TextInput_module_scss_1.default.wrapper, TextInput_module_scss_1.default[variant], className, classNamePrefix + "--wrapper"), style: style },
        ...
        react_1.default.createElement("div", { className: classnames_1.default(TextInput_module_scss_1.default.container, TextInput_module_scss_1.default[variant], classNamePrefix + "--container", (_b = {},
                ...
                _b[TextInput_module_scss_1.default.invalid] = invalid,
                _b)) },
        ...
        react_1.default.createElement("div", { className: classnames_1.default(TextInput_module_scss_1.default.validationMessage, classNamePrefix + "--validation-message") }, validationMessage && validationMessage.length > 0 && validationMessage)));
};
