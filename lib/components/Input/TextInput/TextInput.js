...
exports.Text = exports.InputVariant = void 0;
...
exports.Text = function (_a) {
    var _b;
    var initialValue = _a.initialValue, placeholder = _a.placeholder, variant = _a.variant, icon = _a.icon, label = _a.label, name = _a.name, value = _a.value, error = _a.error, isClearable = _a.isClearable, onChange = _a.onChange, onFocus = _a.onFocus, onBlur = _a.onBlur, style = _a.style, className = _a.className, classNamePrefix = _a.classNamePrefix, rest = __rest(_a, ["initialValue", "placeholder", "variant", "icon", "label", "name", "value", "error", "isClearable", "onChange", "onFocus", "onBlur", "style", "className", "classNamePrefix"]);
    ...
    return (react_1.default.createElement("div", { className: classnames_1.default(TextInput_module_scss_1.default.wrapper, TextInput_module_scss_1.default[variant], className, classNamePrefix + "--wrapper"), style: style },
        ...
        react_1.default.createElement("div", { className: classnames_1.default(TextInput_module_scss_1.default.container, TextInput_module_scss_1.default[variant], classNamePrefix + "--container", (_b = {},
                ...
                _b[TextInput_module_scss_1.default.invalid] = error,
                _b)) },
            ...
            react_1.default.createElement("input", __assign({ type: "text", name: name, value: value !== null && value !== void 0 ? value : currentValue, placeholder: placeholder, className: classnames_1.default(TextInput_module_scss_1.default.input, classNamePrefix + "--input"), onChange: function (e) {
        ...
        react_1.default.createElement("div", { className: classnames_1.default(TextInput_module_scss_1.default.error, classNamePrefix + "--validation-message") }, error && error.length > 0 && error)));
};
