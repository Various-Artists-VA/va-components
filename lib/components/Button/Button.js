...
exports.Button = function (_a) {
    var _b = _a.type, type = _b === void 0 ? "primary" : _b, _c = _a.variant, variant = _c === void 0 ? "medium" : _c, children = _a.children, onClick = _a.onClick, className = _a.className, rest = __rest(_a, ["type", "variant", "children", "onClick", "className"]);
